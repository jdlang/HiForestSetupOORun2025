...
jobTag = 'OO_394153_VertexStudy_highPurity'
inputFilelist = 'file_VertexStudy_MiniAOD_highPurity.txt'

output = '/store/group/phys_heavyions/' + username + '/Run3_OO_2025Data_QuickForest/VertexStudy/'
