...
# with command line options: miniaod --mc --eventcontent MINIAODSIM --datatier MINIAODSIM --conditions 150X_mcRun3_2025_forOO_realistic_v7 --geometry DB:Extended --step PAT --era Run3_2025_OXY --no_exec -n -1
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run3_2025_OXY_cff import Run3_2025_OXY

process = cms.Process('PAT',Run3_2025_OXY)
